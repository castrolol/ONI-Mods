...
namespace AnalyzerDoors
{
	...
	public class CrittersPassableDoorConfig : IBuildingConfig
	{
		public const string ID = "CrittersPassableDoor";
		public static string NAME = "Farm Dor";
		public static string DESC = "Critters Passable Dor allows the critters pass through the door even if it's locked";
		public static string EFFECT = "allows the critters pass through the door even if it's locked.";
		...
		public override BuildingDef CreateBuildingDef()
		{
			...
			BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("CrittersPassableDoor", 1, 2, "critter_passable_door_kanim", 30, 10f, tieR2, allMetals, 1600f, BuildLocationRule.Tile, none2, noise, 1f);
		...
		public static List<LogicPorts.Port> CreateSingleInputPortList(CellOffset offset) => new List<LogicPorts.Port>()
  {
	LogicPorts.Port.InputPort(Door.OPEN_CLOSE_PORT_ID, offset, (string) STRINGS.BUILDINGS.PREFABS.DOOR.LOGIC_OPEN, (string) STRINGS.BUILDINGS.PREFABS.DOOR.LOGIC_OPEN_ACTIVE, (string) STRINGS.BUILDINGS.PREFABS.DOOR.LOGIC_OPEN_INACTIVE)
		...
		{
			var door = go.AddOrGet<CrittersPassableDoor>();
