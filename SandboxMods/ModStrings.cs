...
namespace FreeResourceBuildings
{
    public static class ModStrings
    {
        ...
        public const string HandmadeHeaterID = "HandmadeHeater";
        public const string HandmadeHeaterName = "Handmade Heater";
        public const string HandmadeHeaterEffect = "An infinite fuel heater, made with salvage material";
        public const string HandmadeHeaterDescription = "It allows you to have warm your duplicants without spend logs.";


        public const string BottleVanisherID = "BottleVanisher";
        public const string BottleVanisherName = "Bottle Vanisher";
        public const string BottleVanisherEffect = "The best way to get rid of liquids";
        public const string BottleVanisherDescription = "It Allows you to empty the liquid bottle and make the contents disappear.";


        public const string GasVanisherID = "GasVanisher";
        public const string GasVanisherName = "Gas Bottle Vanisher";
        public const string GasVanisherEffect = "The best way to get rid of gases";
        public const string GasVanisherDescription = "It Allows you to empty the gas bottle and make the contents disappear.";


        public const string ConveyourTrashcanID = "ConveyourTrashcan";
        public const string ConveyourTrashcanName = "Conveyor Tashbin";
        public const string ConveyourTrashcanEffect = "A trash can that was strangely adapted to be used in automation conveyors";
        public const string ConveyourTrashcanDescription = "Allows you to get rid of stuff from your automation conveyor belt";



        public const string FreeConveyourID = "FreeConveyour";
        public const string FreeConveyourName = "Conveyor Generator";
