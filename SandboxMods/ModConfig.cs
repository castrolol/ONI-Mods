...
namespace FreeResourceBuildings
{
	...
	public class ModConfig
	{
		...
		[JsonProperty]
		[Option("Allows Handmade Heater", "If checked, you can build Handmade Heater ", "Handmade Heater")]
		public bool UseHandmadeHeater { set; get; }



		[JsonProperty]
		[Option("Allows Bottle Vanishers", "If checked, you can build Bottle Vanishers for liquid and gas ", "Bottle Vanisher")]
		public bool UseBottleVanisher { set; get; }


		[JsonProperty]
		[Option("Allows Conveyor Generator", "If checked, you can build Conveyor Generator ", "Conveyor Generator")]
		public bool UseConveyorGenerator { set; get; }



		[JsonProperty]
		[Option("Allows Conveyor Trashbin", "If checked, you can build Conveyor Trashbin ", "Conveyor Trashbin")]
		public bool UseConveyorTashcan{ set; get; }
		...
		public ModConfig()
		{
			...
			UseHandmadeHeater = true;
			UseBottleVanisher = true;
			UseConveyorGenerator = true;
			UseConveyorTashcan = true;
